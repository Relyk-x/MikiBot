...
##### Version
    ...
    if message.content.startswith(';youtube '):
        ...
        em.set_author(name=SEARCH + ' YouTube Search')
        em.set_thumbnail(url=imgurl)
        em.add_field(text= '<:yt:511157819689533440>', name='YouTube Channel', value='<channel name>', inline=True)
