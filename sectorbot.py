...
# WATCHING 'over ' + str(len(bot.servers)) + ' servers' ## v0.3.3,9##
...
# Help
    if message.content == ';help':
        em = discord.Embed(title="- click here for help -", description="For any other help please join our Discord server...", url="https://discord.gg/UjuGRB9", color=0xffafc9)
